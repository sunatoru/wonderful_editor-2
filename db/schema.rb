...
ActiveRecord::Schema.define(version: 2021_01_05_210320) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "alticle_likes", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "article_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["article_id"], name: "index_alticle_likes_on_article_id"
    t.index ["user_id"], name: "index_alticle_likes_on_user_id"
  end
  ...
  add_foreign_key "alticle_likes", "articles"
  add_foreign_key "alticle_likes", "users"
